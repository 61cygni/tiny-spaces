...
const MAPFILE = "../games/ps1/maps/palma-anim.js";

function static_images(){
    // all static images to load;
    let static_img = [];

    static_img.push(new LEVEL.StaticImage("field-bg",      "./img/ps1-palma-field-bg.png",   640, 480, 0,0));
    static_img.push(new LEVEL.StaticImage("forest-bg",      "./img/ps1-palma-forest-bg.png",   640, 480, 0,0));
...
var oneShotInit = (function() {
    ...
    return function() {
        if (!executed) {
            ...
            // Sound for camineet
            sound.add('ps1-palma', './audio/ps1-palma.mp3');
            sound.add('battle', './audio/battle.mp3');
