...
function static_images(){
    ...
    static_img.push(new LEVEL.StaticImage("start",      "./img/intro-screen.png",   640, 480, 0,0));
    static_img.push(new LEVEL.StaticImage("intro1",      "./img/intro-one.png",     640, 1280, 0,0));
    static_img.push(new LEVEL.StaticImage("intro3",      "./img/intro-three.png",   640, 480, 0,0));
    static_img.push(new LEVEL.StaticImage("intro4",      "./img/intro-four.png",   640, 480, 0,0));
    static_img.push(new LEVEL.StaticImage("intro5",      "./img/intro-five.png",   640, 480, 0,0));
...
var oneShotInit = (function() {
    ...
    return function() {
        if (!executed) {
            ...
            // Sound for camineet
            sound.add('title', './audio/title.mp3');
            sound.add('intro', './audio/intro.mp3');
