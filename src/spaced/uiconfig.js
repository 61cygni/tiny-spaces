...
export const DIALOG_MAX_HEIGHT = DIALOG_HEIGHT - (2*DIALOG_PADDING) // max height of text in dialog
...
export const TEXTINPUT_MAX_HEIGHT = TEXTINPUT_HEIGHT - (2*TEXTINPUT_PADDING)
export const TEXTINPUT_MAX_WIDTH  = TEXTINPUT_WIDTH  - (2*TEXTINPUT_PADDING)
